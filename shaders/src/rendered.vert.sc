...
//    v_fragPosLightSpace_1 = mul(spotLights(1).lightSpaceMatrix, vec4(v_fragPos, 1.0));
    ...
    //        dirLights_fragPos(i) = mul(dirLights(i).lightSpaceMatrix, vec4(v_fragPos, 1.0));
    //        ++nbLight;
    //    }
    //#endif
    ...
    //        //        spotLights_fragPos(i) = mul(spotLights(i).lightSpaceMatrix, vec4(v_fragPos, 1.0));
    //        if (i == 0) {
    //            spotLights_fragPos(0) = mul(spotLights(0).lightSpaceMatrix, vec4(v_fragPos, 1.0));
    //        }
    //        else if (i == 1) {
    //            spotLights_fragPos(1) = mul(spotLights(1).lightSpaceMatrix, vec4(v_fragPos, 1.0));
    //        }
    //        ++nbLight;
    //    }
    ...
    //    int i =0;
    //    spotLights_setFragPos(i, mul(spotLights(0).lightSpaceMatrix, vec4(v_fragPos, 1.0)));
    //    v_fragPosLightSpace_0 = vec4_splat(0.0);
    //    fragPosLightSpaces(0) = vec4_splat(0.0);
    //        v_fragPosLightSpace_1 = mul(spotLight_0.lightSpaceMatrix, vec4(v_fragPos, 1.0));
    //        v_fragPosLightSpace_1 = mul(spotLight_0.lightSpaceMatrix, vec4(v_fragPos, 1.0));
    //    fragPosLightSpaces(1) = mul(spotLights(1).lightSpaceMatrix, vec4(v_fragPos, 1.0));
